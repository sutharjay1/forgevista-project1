...
const AboutUs = () => {
	return (
		<div className="w-full h-full flex flex-col items-center justify-center transition-all selection:bg-[#0a755862]">
						...
						<div className="items-center justify-items-center gap-x-4 gap-y-5 ">
							<div className="flex items-center justify-center">
								<div className="px-2 space-y-4">
									<p className="text-xl    text-[#16191E] md:text-4xl">
										About Us
									</p>
			...
			<div className="max-w-7xl  w-full h-fit flex flex-col items-center justify-center px-3 md:px-4 py-20 space-y-4   ">
				<div className="w-full flex items-center justify-start gap-5 ">
					<span className="text-3xl md:text-5xl font-semibold text-[#16191E]">
						Our Team
					</span>
				</div>
				<div className="w-full h-fit grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3   gap-14">
					<TeamCard
